# This code was taken directly from bwentzloff
# The code was lifted in order to be quickly adapated for this project and Python3
# Original code: https://github.com/bwentzloff/trading-bot
