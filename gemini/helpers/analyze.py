...
from cmo_strategy_params import cmo_params
...
def analyze_bokeh(algo, data_CMO, title=None, show_trades=False):
    ...
    bokeh.plotting.output_file("trading_strategy_graph.html", title=title)
    ...
    cmo_above_50 = bokeh.models.Span(location=cmo_params['OVERBOUGHT_VALUE(0:100)'],
                                     dimension="width",
                                     line_dash="dashed",
                                     line_color="green",
                                     y_range_name="cmo_y_axis")

    cmo_below_70 = bokeh.models.Span(location=cmo_params['OVERSOLD_VALUE(-100:0)'],
                                     dimension="width",
                                     line_dash="dashed",
                                     line_color="green",
                                     y_range_name="cmo_y_axis")
